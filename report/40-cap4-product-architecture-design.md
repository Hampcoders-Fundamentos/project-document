...
### 4.1.6 Design Patterns 4.1.7 Tactics
...
#### 4.2.X.6 Sketch Views (C4 & UML) and Record Design Decisions 4.2.X.7 Analysis of Current Design and Review Iteration Goal (Kanban Board)